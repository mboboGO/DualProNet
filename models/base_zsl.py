...
class Model(nn.Module):
    ...
    def forward(self, x):
        ...
        return (ood_logit,zsr_logit,zsr_logit_aux),(ood_x,zsr_x)
...
def base_r50(pretrained=True, loss_params=None, args=None):
...
def base_r101(pretrained=True, loss_params=None, args=None):
    """Constructs a ResNet-101 model.
